...
private:
    ...
    TSharedPtr<FJsonObject> HandleAuditBlueprint(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleOrganizeBlueprintGraph(const TSharedPtr<FJsonObject>& Params);
